...
type Querier interface {
	...
	GetControllerNodesBySystemControllerID(ctx context.Context, parentID int32) ([]GetControllerNodesBySystemControllerIDRow, error)
	GetNodeById(ctx context.Context, id int32) (Node, error)
	GetStorageNodesBySystemControllerID(ctx context.Context, parentID int32) ([]GetStorageNodesBySystemControllerIDRow, error)
	...
	GetWorkerNodesBySystemControllerID(ctx context.Context, parentID int32) ([]GetWorkerNodesBySystemControllerIDRow, error)
	...
	UpdateSystemControllerAdminPass(ctx context.Context, arg UpdateSystemControllerAdminPassParams) (SystemController, error)
